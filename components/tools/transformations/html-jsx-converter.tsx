    ...
    jsx = jsx.replace(/style="([^"]*)"/g, (match, styles) => {
      const styleObj = styles
        ...
        .map((style: string) => {
          ...
          if (property && value) {
            const camelCaseProperty = property.replace(/-([a-z])/g, (g: string) => g[1].toUpperCase())
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <Tabs value={mode} onValueChange={(value) => setMode(value as "html-to-jsx" | "jsx-to-html")}>
            <TabsList>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="space-y-2">
            <label className="text-sm font-medium">{mode === "html-to-jsx" ? "HTML Input" : "JSX Input"}</label>
            <Textarea
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium">{mode === "html-to-jsx" ? "JSX Output" : "HTML Output"}</label>
            <div className="relative">
              <Textarea
                value={jsxOutput}
                readOnly
                className="font-mono h-64 pr-10"
