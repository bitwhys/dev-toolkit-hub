...
export const metadata: Metadata = {
  ...
  description:
    'Convert HTML to JSX and vice versa. Transform HTML syntax to React JSX components instantly.',
}
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Convert between HTML and JSX syntax. Transform HTML elements to React JSX components and
          vice versa.
        </p>
      </div>
      <HtmlJsxConverter />
